...
public class Camera2BasicFragment extends Fragment
  ...
  Runnable runnable = new Runnable() {
    ...
    public void run() {
      try {
        ...
        if (firstname.equals("waguan") && panduan > 0.75 && isStart == false) {
        ...
        if (isStart == true && miao >= 3) {
          Intent intent = new Intent(getActivity(), ShowVideo.class);
          miao = 0;
  ...
  public View onCreateView(
    ...
    mediaPlayer = MediaPlayer.create(getContext(), R.raw.xiaoxiaole);
    ...
    vto.addOnGlobalLayoutListener(
            new ViewTreeObserver.OnGlobalLayoutListener() {
              ...
              public void onGlobalLayout() {
                ...
                sheetBehavior.setPeekHeight(7400);
              }
            });
  ...
  private void classifyFrame() {
    ...
    if (textToShow.toString().indexOf(":") != -1) {
      ...
      firstname=token;
      String value= textToShow.toString().substring(textToShow.toString().indexOf(":")+2,textToShow.toString().indexOf("\n"));
      panduan=Double.parseDouble(value);
